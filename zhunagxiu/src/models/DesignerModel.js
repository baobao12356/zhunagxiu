...
let designerModel = {
  //获取设计师详情
  getDesignerInfo(designerId,serviceShowFlag) {
    return new Promise((resolve, reject) => {
      const param = serviceShowFlag==1 ? `&serviceShowFlag=1`:""
      const url = `/api-jiazhuang/c/hxapp/designer/info?id=${designerId+param}` ;
