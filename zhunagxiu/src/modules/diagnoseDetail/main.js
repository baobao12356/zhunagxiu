...
export default class Details extends React.Component {
  constructor(props) {
    ...
    //分享
     this.share = {
      ...
      link: `${Host.path}/mainapp/diagnoseDetail.html?detailId=${this.askId}`
    };
  ...
  componentDidMount() {
    ...
    AskingDetail(this.askId, 1).then((res) => {
      console.log(res);
...
//    this.point.p('110.300.49.58.68.78.03','deco','page.Apartmentlayoutproblem.detail','Apartment layout problem detail');
  }
  ...
  render() {
    ...
    return (
      <div className={cs({"planComment_box":true,'app-wrap':Env.rsApp,'ios-nav': Env.rsApp && Env.ios,'webPadding':this.state.webPadding, 'img-center': true})}>
        {/*<Nav title='户型问诊详情' initShareData="true" share={this.share} hideNav="true" showTip="true"/>*/}
        <Nav title='户型问诊详情' shareIcon={false} hideNav={true} showTip={true}/>
